...
RDEPEND=">=dev-haskell/asn1-encoding-0.9:=[profile?] <dev-haskell/asn1-encoding-0.10:=[profile?]
	...
	>=dev-haskell/crypton-0.34:=[profile?] <dev-haskell/crypton-0.35:=[profile?]
	...
	>=dev-haskell/crypton-x509-validation-1.6.5:=[profile?] <dev-haskell/crypton-x509-validation-1.7:=[profile?]
