...
# dev-qt/designer:5 was added since it seems to be the missing QtTools in:
...
pkg_postinst() {
	...
	elog "The app is supposed to be run with the wrapper \`opentoonz\` script,"
	elog "and not the \`OpenToonz\` binary, since the former will initialize"
	elog "all the necessary settings."
}
