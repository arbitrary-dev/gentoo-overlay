...
IUSE="aalib alsa aqua debug doc gnome heif jpeg2k jpegxl mng openexr +pdf postscript udev unwind vector-icons webp wmf xpm cpu_flags_ppc_altivec cpu_flags_x86_mmx cpu_flags_x86_sse"
...
PATCHES=(
	...
	"${FILESDIR}/${P}_allow_pdf_to_be_opt-out.patch"
)
