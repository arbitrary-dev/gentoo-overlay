...
PATCHES=(
	...
	"${FILESDIR}"/${P}-add-workaround-for-cleanup-channel-segfault.patch
	"${FILESDIR}"/${P}-remove-false-no-ogg-support-log.patch
	"${FILESDIR}"/${P}-add-proper-check-for-colorkey.patch
)
